...
class Login extends React.Component {
    ...
    resetUser =() => {
        ...
        if(!this.state.isValidLogin) {
            this.setState({user: {email, passwordhash}});
        }
          ...
          return(
            <AuthContext.Consumer>
                {userDetails => {
                 ...
                 const {email, passwordhash} = this.state.user;
        return ( 
            ...
            <div className="row card card-body bg-light" style={{width:400,textAlign:"left"}}>
              ...
              <form onSubmit={e => this.onSubmitForm(e, setUser)}>
                ...
                <input value={passwordhash} type="password" className="form-control" name="passwordhash" onChange={this.onTextChange}  placeholder="Enter your password" />
                <br/>
